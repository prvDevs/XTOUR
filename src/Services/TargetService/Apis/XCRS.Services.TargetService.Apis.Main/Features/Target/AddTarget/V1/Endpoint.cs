...
using XCRS.Services.TargetService.Application.Bases.Endpoints;
...
namespace XCRS.Services.TargetService.Apis.Main.Features.Target.AddTarget.V1
{
    [ProducesResponseType(typeof(Response<AddTargetHandlerResp>), (int)HttpStatusCode.OK)]
    [ProducesResponseType(typeof(Response), (int)HttpStatusCode.BadRequest)]
    public class AddTargetAsync : BaseTargetEndpoint<AddTargetHandlerReq, Response<AddTargetHandlerResp>>
    {
